...
#define DESCRIPTOR_SET_OUTPUT_IMAGE               0
#define DESCRIPTOR_BINDING_OUTPUT_IMAGE           1

#define DESCRIPTOR_SET_SCENE_DATA                 0
#define DESCRIPTOR_BINDING_SCENE_DATA             2

#define DESCRIPTOR_SET_CAMERA_DATA                0
#define DESCRIPTOR_BINDING_CAMERA_DATA            3

// Set 1
#define DESCRIPTOR_SET_VERTEX_ATTRIBUTES          1
